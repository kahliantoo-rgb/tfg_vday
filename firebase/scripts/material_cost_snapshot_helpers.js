/**
 * Shared material cost snapshot logic for Node backfill / Shopify import.
 */
...
function orderQualifiesForMaterialCostSnapshot(order) {
...
module.exports = {
  ...
  computeOrderMaterialCostSnapshot,
