...
import 'orderlist_model.dart';
export 'orderlist_model.dart';
                        ...
                        children: [
                            ...
                            builder: (context, snapshot) {
                              ...
                              return FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  _model.cSv = await actions.exportOrdersToCsv(
                          ...
                          StreamBuilder<List<OrderItemRecord>>(
                            stream: queryOrderItemRecord(
                              queryBuilder: (orderItemRecord) => orderItemRecord
                                  .where(
                                    'deliverydate',
                            ...
                            builder: (context, snapshot) {
                              ...
                              return FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  _model.fulllist =
                                      await actions.exportOrderItemsFinalCsv(
                                    buttonOrderItemRecordList.toList(),
                                  );
                                  await downloadFile(
                                    filename: 'OrderList${dateTimeFormat(
                                      "d/M/y",
                                    ...
                                    uploadedFile: _model.fulllist!,
                                  );

                                  safeSetState(() {});
                                },
                                text: 'Export full list',
                                icon: Icon(
                                  Icons.file_download,
                                  size: 20.0,
                                ),
                                ...
                                return StreamBuilder<List<OrderItemRecord>>(
                                  stream: queryOrderItemRecord(
                                    queryBuilder: (orderItemRecord) =>
                                      ...
                                      'orderRef',
                                      isEqualTo: listViewOrdersRecord.reference,
                                    ),
                                  ),
                                  builder: (context, snapshot) {
                                    // Customize what your widget looks like when it's loading.
                                                  ...
                                                  child: Checkbox(
                                                    ...
                                                    onChanged:
                                                      ...
                                                      safeSetState(() => _model
                                                          ...
                                                          newValue!);
                                                      if (newValue!) {
                                                        _model.addToCheckedOrders(
                                                            listViewOrdersRecord
                                                                .reference);
                                                        safeSetState(() {});
                                                      } else {
                                                        _model.removeFromCheckedOrders(
                                                            listViewOrdersRecord
                                                                .reference);
                                                        safeSetState(() {});
                                                      }
                                            ...
                                            Padding(
                                              padding: EdgeInsetsDirectional
                                                  .fromSTEB(
                                                      118.0, 0.0, 0.0, 0.0),
                                              child: Text(
                                                'Delivery Address：${listViewOrdersRecord.address}',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
                                                        .override(
                                            ...
                                            Padding(
                                              padding: EdgeInsetsDirectional
                                                  .fromSTEB(
                                                      119.0, 0.0, 0.0, 0.0),
                                              child: Text(
                                                'Time_slots：${listViewOrdersRecord.deliveryTimeSlot}',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
                                                        .override(
                                            ...
                                            Padding(
                                              padding: EdgeInsetsDirectional
                                                  .fromSTEB(
                                                      119.0, 0.0, 0.0, 0.0),
                                              child: Text(
                                                'Region：${listViewOrdersRecord.region}',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
                                                        .override(
                                            ...
                                            Padding(
                                              padding: EdgeInsetsDirectional
                                                  .fromSTEB(
                                                      119.0, 0.0, 0.0, 0.0),
                                              child: Text(
                                                'Method：${listViewOrdersRecord.pickupDelivery}',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
                                                        .override(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        for (int loop1Index = 0;
                                            loop1Index <
                                                _model.checkedOrders.length;
                                            loop1Index++) {
                                          final currentLoop1Item =
                                              _model.checkedOrders[loop1Index];
