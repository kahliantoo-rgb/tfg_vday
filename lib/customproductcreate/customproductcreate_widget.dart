...
import 'customproductcreate_model.dart';
export 'customproductcreate_model.dart';

class CustomproductcreateWidget extends StatefulWidget {
  const CustomproductcreateWidget({
    super.key,
  ...
  static String routeName = 'customproductcreate';
  static String routePath = '/customproductcreate';

  @override
  State<CustomproductcreateWidget> createState() =>
      _CustomproductcreateWidgetState();
}

class _CustomproductcreateWidgetState extends State<CustomproductcreateWidget> {
  late CustomproductcreateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CustomproductcreateModel());
    ...
    _model.qtyFocusNode!.addListener(() => safeSetState(() {}));
                                ...
                                children: [
                                  TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      filled: true,
                                      fillColor: (_model.productNameFocusNode
                                                  ?.hasFocus ??
                                              false)
                                          ? Color(0x4D9489F5)
                                          : Colors.white,
                                  ...
                                  TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      filled: true,
                                      fillColor:
                                          (_model.priceFocusNode?.hasFocus ??
                                                  false)
                                              ? Color(0x4D9489F5)
                                              : Colors.white,
                                      contentPadding:
                                  ...
                                  TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      filled: true,
                                      fillColor:
                                          (_model.remarkFocusNode?.hasFocus ??
                                                  false)
                                              ? Color(0x4D9489F5)
                                              : Colors.white,
                                      contentPadding:
