...
import 'd_o_model.dart';
export 'd_o_model.dart';
...
class DOWidget extends StatefulWidget {
  ...
  static String routeName = 'dO';
  static String routePath = '/dO';
...
class _DOWidgetState extends State<DOWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DOModel());
                  ...
                  child: Column(
                    ...
                    children: [
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          valueOrDefault<String>(
                                            rowCompaniesRecord?.companyPhone,
                                            'NA',
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                        ...
                                        Text(
                                          'UEN:${rowCompaniesRecord?.companyUen}',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                font: GoogleFonts.inter(
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 2.0, 0.0, 0.0),
                                            child: Text(
                                              'S(${containerOrdersRecord.postalCode}）',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                                      .override(
                      ...
                      Padding(
                        ...
                        child: Container(
                          child: Text(
                            'Thank you for choosing The Flower Guy Pte Ltd. ',
