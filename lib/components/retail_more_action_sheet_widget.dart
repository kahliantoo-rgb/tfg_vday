...
import 'retail_more_action_sheet_model.dart';
export 'retail_more_action_sheet_model.dart';
...
class RetailMoreActionSheetWidget extends StatefulWidget {
  const RetailMoreActionSheetWidget({
    super.key,
  ...
  @override
  State<RetailMoreActionSheetWidget> createState() =>
      _RetailMoreActionSheetWidgetState();
}

class _RetailMoreActionSheetWidgetState
    extends State<RetailMoreActionSheetWidget> {
  late RetailMoreActionSheetModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RetailMoreActionSheetModel());
                            ...
                            child: StreamBuilder<List<OrderItemRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<OrderItemRecord>
                                    columnOrderItemRecordList = snapshot.data!;
                                // Return an empty Container when the item does not exist.
                                if (snapshot.data!.isEmpty) {
                                  return Container();
                                }
                                final columnOrderItemRecord =
                                    columnOrderItemRecordList.isNotEmpty
                                        ? columnOrderItemRecordList.first
                                        : null;
