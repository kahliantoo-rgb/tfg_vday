...
import 'delivery_receipt_preview_page_model.dart';
export 'delivery_receipt_preview_page_model.dart';

/// Create a FlutterFlow page named "ReceiptPreviewPage" for POS receipt
/// preview and printing.
///
/// Purpose:
/// Display a printable receipt layout for POS orders.
///
/// Data Source:
/// - Orders document
/// - Related companyRef → Companies
///
/// Layout:
/// - White background, receipt-style narrow column
/// - Centered content, padding 16
///
/// Header:
/// - Company Name (bold, large)
/// - Company UEN (shown only if not empty)
/// - Company Phone
/// - Company Address
///
/// Order Info:
...
/// Items Section:
/// - List of order_items
/// - Show product name, qty, unit price, subtotal
///
/// Summary:
/// - Subtotal
/// - Tax (if any)
...
///
/// Rules:
/// - Use Conditional Visibility for UEN
/// - FlutterFlow native widgets only
/// - Optimized for thermal printer width
class DeliveryReceiptPreviewPageWidget extends StatefulWidget {
  const DeliveryReceiptPreviewPageWidget({
    super.key,
  ...
  static String routeName = 'DeliveryReceiptPreviewPage';
  static String routePath = '/deliveryreceiptPreviewPage';

  @override
  State<DeliveryReceiptPreviewPageWidget> createState() =>
      _DeliveryReceiptPreviewPageWidgetState();
}

class _DeliveryReceiptPreviewPageWidgetState
    extends State<DeliveryReceiptPreviewPageWidget> {
  late DeliveryReceiptPreviewPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeliveryReceiptPreviewPageModel());
                                ...
                                children: [
                                  Text(
                                    valueOrDefault<String>(
                                      columnCompaniesRecord?.companyName,
                                      'xxx company',
                                    ),
                                  ...
                                  Text(
                                    valueOrDefault<String>(
                                      columnCompaniesRecord?.companyAddress,
                                      'aaaaa',
                                    ),
                                    textAlign: TextAlign.center,
                                    maxLines: 3,
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    dateTimeFormat(
                                      "ddmmyyy",
                                      containerOrdersRecord!.createdTime!,
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    valueOrDefault<String>(
                                      containerOrdersRecord?.paymentType,
                                      'Na',
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                            ...
                            children: [
                              ...
                              StreamBuilder<List<OrderItemRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return ReceiptOrderItemList(
                                    items: listViewOrderItemRecordList,
