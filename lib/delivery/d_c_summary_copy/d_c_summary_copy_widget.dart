                        ...
                        itemBuilder: (context, listViewIndex) {
                          ...
                          return Padding(
                            ...
                            child: InkWell(
                              ...
                              onLongPress: () async {
                                await listViewOrderItemRecord.reference
                                    .delete();
                              },
                              child: Container(
                                width: double.infinity,
                                              ...
                                              children: [
                                                if (listViewOrderItemRecord
                                                  ...
                                                  FlutterFlowIconButton(
                                                    ...
                                                    onPressed: () async {
                                                      await listViewOrderItemRecord
                                                          .reference
                                                          .update({
                                                        ...createOrderItemRecordData(
                                                          subtotal: functions.decreaseQtysubtotal(
                                                              listViewOrderItemRecord
                                                                  .price,
                                                              listViewOrderItemRecord
                                                                  .qty),
                                                ...
                                                FlutterFlowIconButton(
                                                  ...
                                                  onPressed: () async {
                                                    await listViewOrderItemRecord
                                                        ...
                                                        .update({
                                                      ...createOrderItemRecordData(
                                                        subtotal: functions.increaseQtySubtotal(
                                                            listViewOrderItemRecord
                                                                .price,
                                                            listViewOrderItemRecord
                                                                .qty),
