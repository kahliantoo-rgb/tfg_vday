...
import 'delivery_order_print_model.dart';
export 'delivery_order_print_model.dart';

/// Design a clean, print-friendly Delivery Order page for a web-based order
/// management system.
///
/// The layout should be suitable for A4 printing with a white background and
...
///
/// Order Items table:
/// - Columns: Item Name, Quantity, Subtotal
/// - Display multiple items in a structured table layout
///
/// Summary section:
/// - Subtotal
/// - Tax (if any)
...
/// - Date
///
/// The design should be simple, professional, black-and-white, and optimized
/// for printing using a browser print function (Ctrl+P).
class DeliveryOrderPrintWidget extends StatefulWidget {
  const DeliveryOrderPrintWidget({
    super.key,
  ...
  static String routeName = 'DeliveryOrderPrint';
  static String routePath = '/deliveryOrderPrint';

  @override
  State<DeliveryOrderPrintWidget> createState() =>
      _DeliveryOrderPrintWidgetState();
}

class _DeliveryOrderPrintWidgetState extends State<DeliveryOrderPrintWidget> {
  late DeliveryOrderPrintModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeliveryOrderPrintModel());
                                        ...
                                        Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                'UEN:${containerCompaniesRecord?.companyUen}',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
                                                        .override(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Text(
                                            dateTimeFormat(
                                              "yMd",
                                              columnOrdersRecord!.deliveryDate!,
                                              locale:
                                                  FFLocalizations.of(context)
                                                      .languageCode,
                                            ),
                                ...
                                return Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        '${'Method:${containerOrdersRecord?.pickupDelivery}'}',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              font: GoogleFonts.inter(
                                      ...
                                      Text(
                                        '${'Region:${containerOrdersRecord?.region}'}',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              font: GoogleFonts.inter(
