...
import 'receipt_previewpage2_model.dart';
export 'receipt_previewpage2_model.dart';
...
class ReceiptPreviewpage2Widget extends StatefulWidget {
  ...
  @override
  State<ReceiptPreviewpage2Widget> createState() =>
      _ReceiptPreviewpage2WidgetState();
}

class _ReceiptPreviewpage2WidgetState extends State<ReceiptPreviewpage2Widget> {
  late ReceiptPreviewpage2Model _model;
                                    ...
                                    StreamBuilder<List<CompaniesRecord>>(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        final buttonCompaniesRecord =
                                            buttonCompaniesRecordList.isNotEmpty
                                                ? buttonCompaniesRecordList
                                                    .first
                                                : null;
