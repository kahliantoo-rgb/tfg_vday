...
class EscPosReceiptBuilder {
  ...
  Future<void> divider() async {
    await writeLine('=' * escPosLineWidth);
  }
...
Future<List<int>> buildEscPosReceiptBytes({
  ...
  if (order.paymentType.isNotEmpty) {
    await builder.writeLine('Payment: ${order.paymentType}');
  }
  if (cashierName != null && cashierName.trim().isNotEmpty) {
    await builder.writeLine('Cashier: ${cashierName.trim()}');
  }
